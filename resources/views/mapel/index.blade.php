                    ...
                    <div class="modal-body">
                      <form method="POST" action="{{ route('mapel.store') }}">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="kode_mapel" value="MP-{{ time() }}" readonly="" class="form-control">
                        </div>
                        <div class="form-group">
                          <label>Nama Mapel</label>
                          <input type="text" name="mapel" class="form-control" placeholder="Nama Mapel">
                        </div>
                    </div>
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <form method="POST" action="{{ route('mapel.update') }}">
                        ...
                        <div class="form-group">
                          <label>Nama Mapel</label>
                          <input type="text" name="mapel" id="mapel" class="form-control" placeholder="Nama Kelas" required>
                        </div>
                    </div>
                    <div class="modal-footer justify-content-between">
                      <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
