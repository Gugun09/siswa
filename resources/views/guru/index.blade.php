          ...
          <div class="col-12">
              ...
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  <!-- <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-tambah">Tambah Guru</button> -->
                </h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <td>{{ $gurus->name }}</td>
                    <td>{{ $gurus->email }}</td>
                    <td>{!! $gurus->status == 'Y' ? '<span class="badge badge-success">Aktif</span>' : '<span class="badge badge-danger">Tidak Aktif</span>' !!}</td>
                    <td>
                      <a href="{{ route('guru.edit', $gurus->id) }}" class="btn btn-warning btn-sm">Edit</a>
                      <!-- <button class="btn btn-warning btn-sm edit" id="{{ $gurus->id }}" data-toggle="modal" data-target="#modal-edit">Edit</button> -->
